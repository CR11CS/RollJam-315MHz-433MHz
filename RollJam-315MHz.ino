...
// Carrier frequency = 314.999664 MHz
...
#define CC1101_DEFVAL_FREQ0_315  0x89      // Frequency Control Word, Low Byte               38   

// Carrier frequency Jammer = 310.999847
#define CC1101_DEFVAL_FREQ2_315_JAMMER  0x0B        // Frequency Control Word, High Byte
#define CC1101_DEFVAL_FREQ1_315_JAMMER  0xF6        // Frequency Control Word, Middle Byte
#define CC1101_DEFVAL_FREQ0_315_JAMMER  0x27       // Frequency Control Word, Low Byte               38   
...
replaySecond();
  ...
  void setupJammer()
  {
    ...
    wait_Miso();
    setDefaultRegs();
    writeReg(CC1101_FREQ1, CC1101_DEFVAL_FREQ1_315_JAMMER);
    writeReg(CC1101_FREQ0, CC1101_DEFVAL_FREQ0_315_JAMMER);
